  ...
  return (
    <section className="stats-grid animate-fade-in">
        ...
        <div className="stat-card">
            ...
            <div className="stat-info"><h3>Páginas Visualizadas</h3><p>{stats.visualizacoes.pageviews.toLocaleString()}</p><div style={{marginTop: '8px', fontSize: '11px', color: '#555'}}>⏱️ Tempo médio: <strong>{stats.visualizacoes.tempo_medio}</strong></div></div>
        </div>
