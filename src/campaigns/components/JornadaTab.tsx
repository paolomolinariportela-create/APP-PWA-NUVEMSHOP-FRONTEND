...
export function JornadaTab({ token, API_URL, brl }: Props) {
    ...
    if (loading) return (
        <div style={{ textAlign: 'center', padding: '60px 20px', color: C.textSoft, fontSize: '14px' }}>
            Carregando jornada...
        </div>
    );
    ...
    if (!jornada.length) return (
        <div style={{ textAlign: 'center', padding: '60px 20px', color: C.textSoft }}>
            <div style={{ fontSize: '32px', marginBottom: '12px', color: C.neutralLight, display: 'flex', justifyContent: 'center' }}>
                {Icon.map}
            </div>
            <div style={{ fontWeight: 700, fontSize: '15px', color: C.text, marginBottom: '8px' }}>
                Nenhuma jornada registrada ainda
            </div>
            <div style={{ fontSize: '13px', lineHeight: 1.6, maxWidth: '340px', margin: '0 auto', color: C.textSoft }}>
    ...
    return (
        <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '10px', marginBottom: '20px' }}>
                    {[
                        ...
                        <div key={i} style={{
                            ...
                            <div style={{ fontSize: '22px', fontWeight: 700, color: card.color, letterSpacing: '-0.02em' }}>
                                {card.value}
                            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: '16px' }}>
                ...
                <div>
                    <div style={{
                        fontSize: '13px', fontWeight: 700, color: C.neutralLight,
                            ...
                            return (
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: ativa ? C.dark : C.neutralBg,
                                ...
                                >
                                    ...
                                    <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                                        <span style={{ fontSize: '13px', color: ativa ? C.neutralLight : C.textSoft }}>
                                            {j.cliques} cliques
                                        </span>
                                        {j.convertidos > 0 && (
                                            <span style={{
                                                background: ativa ? '#10B98130' : C.successBg,
                                                color: ativa ? '#6ee7b7' : C.success,
                ...
                {n && (
                    <div>
                        ...
                        <div style={{
                            background: C.dark, borderRadius: '10px',
                            ...
                            {etapas.map((e, i) => (
                                <React.Fragment key={i}>
                                    <div style={{
                                        ...
                                        <div style={{
                                            fontSize: '22px', fontWeight: 800, color: e.cor,
                                    ...
                                    {i < etapas.length - 1 && (
                                        <div style={{
                                            ...
                                            alignItems: 'center', padding: '0 6px', flexShrink: 0,
                                        }}>
                                            <div style={{
                                                fontSize: '13px', fontWeight: 700,
                                                color: i === 0 ? '#3b82f6' : C.success,
                                            }}>
                            ...
                            {[
                                ...
                                <div key={i} style={{ marginBottom: i === 0 ? '8px' : '0' }}>
                                    <div style={{
                                        ...
                                        fontSize: '13px', color: C.textSoft, marginBottom: '3px',
                                    }}>
                                        <span>{b.label}</span>
                                        <span style={{ fontWeight: 600, color: b.ok ? C.success : C.danger }}>
                                            {b.pct}%
                                        </span>
                                    </div>
                                    <div style={{
                                        background: C.neutralBorder, borderRadius: '999px',
                                        height: '6px', overflow: 'hidden',
                                    }}>
                                        <div style={{
                                            width: `${b.pct}%`, background: b.cor,
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                            ...
                            <div style={{
                                ...
                                <div style={{ fontSize: '13px', fontWeight: 600, color: C.success, marginBottom: '8px' }}>
                                    Compraram ({convertidos.length})
                                </div>
                                {convertidos.length === 0 ? (
                                    <div style={{ fontSize: '13px', color: C.textSoft, textAlign: 'center', padding: '8px 0' }}>
                                        Nenhuma conversão
                                    </div>
                                ) : (
                                    <div style={{
                                        ...
                                        {convertidos.map((s, i) => (
                                            <div key={i} style={{
                                                ...
                                                <div>
                                                    <div style={{ fontSize: '13px', fontFamily: 'monospace', color: C.textMid }}>
                                                        {s.visitor_id.substring(0, 14)}…
                                                    </div>
                                                    <div style={{ fontSize: '13px', color: C.textSoft }}>
                                                        {formatDate(s.clicked_at)}
                                                    </div>
                                                </div>
                                                {s.revenue && (
                                                    <div style={{ fontSize: '13px', fontWeight: 700, color: C.success }}>
                                                        {brl(s.revenue)}
                                                    </div>
                                                )}
                                            </div>
                            ...
                            <div style={{
                                ...
                                <div style={{ fontSize: '13px', fontWeight: 600, color: C.warning, marginBottom: '8px' }}>
                                    Não compraram ({naoConvertidos.length})
                                </div>
                                {naoConvertidos.length === 0 ? (
                                    ...
                                    <div style={{
                                        ...
                                        {naoConvertidos.map((s, i) => (
                                            <div key={i} style={{
                                                background: '#fff', borderRadius: '6px', padding: '7px 10px',
                                            }}>
                                                <div style={{ fontSize: '13px', fontFamily: 'monospace', color: C.textMid }}>
                                                    {s.visitor_id.substring(0, 14)}…
                                                </div>
