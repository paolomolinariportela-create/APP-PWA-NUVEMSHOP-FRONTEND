...
export default function AdminPanel() {
  ...
  const [activeTab, setActiveTab] = useState<"dashboard" | "campanhas" | "config" | "planos">("dashboard");
  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="dashboard-content">
        ...
        {activeTab === "campanhas" && (
          <TabCampaigns stats={stats} pushForm={pushForm} setPushForm={setPushForm} handleSendPush={handleSendPush} sendingPush={sendingPush} token={token} API_URL={API_URL} />
        )}
        {activeTab === "planos" && (
